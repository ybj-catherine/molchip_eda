...
> 📚 **116 篇论文深度讲解** · 108 个论文目录 · 全部分类 + 开源标注 + 点击直达
> 🏷️ 初版 v0.3 — 后续持续更新完善
...
本仓库为 AI4EDA（AI for Electronic Design Automation）领域 **116 篇论文** 提供统一格式的深度技术解读。
...
molchip_eda/
├── README.md                         ← 你在这里
├── 00-总索引.md                      ← 完整导航（115 篇分类总表 + 覆盖率反查 + 组会轮次）
├── 芯片流程.md                       ← 17 阶段标准编号定义（①-⑰）
├── _合并规范.md                      ← 12 节骨架写作规范
├── _校验.py                          ← 机器校验脚本
