...
> 📚 **112 篇论文深度讲解** · 104 个论文目录 · 全部分类 + 开源标注 + 点击直达
> 🏷️ 初版 v0.3 — 后续持续更新完善
> 📖 完整导航：[00-总索引.md](00-总索引.md) · 校验：`python3 _校验.py`（112/112 通过 ✅）

---

## 30 秒速览

本仓库为 AI4EDA（AI for Electronic Design Automation）领域 **112 篇论文** 提供统一格式的深度技术解读。
...
| 验证、修复与形式化 + DFT | 18 | 9 | 6 | 3 |
| 物理设计与跨阶段 | 7 | 4 | 3 | 0 |
| EDA Agent 与流程编排 | 3 | 2 | 0 | 1 |
| 跨领域 | 11 | 6 | 4 | 1 |
| 综述 | 4 | 0 | 0 | 4 |
| **总计** | **112** | **71 (63%)** | **28 (25%)** | **13 (12%)** |
...
molchip_eda/
├── README.md                         ← 你在这里
├── 00-总索引.md                      ← 完整导航（112 篇分类总表 + 覆盖率反查 + 组会轮次）
├── 芯片流程.md                       ← 17 阶段标准编号定义（①-⑰）
├── _合并规范.md                      ← 12 节骨架写作规范
├── _校验.py                          ← 机器校验脚本
...
├── 新增参考文献_20260804.bib
│
├── <论文目录> ×104/                   ← 每个目录 = 论文深度讲解.md + PDF + TXT
